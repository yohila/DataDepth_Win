...
// Compare3 UPoints descending
static int Compare3(UPoint p1, UPoint p2){
...
/* The input of MahalanobisDepth function are diffrents 
	if (depthType == 2)
...
void knnGetClasses(TDMatrix learnpoints, int* learnlabels, int nlearn, int d,
	...
	/*	for (int i = 0; i < nlearn; i++){
		...
		sort(depths.begin(), depths.end(), Compare3);
